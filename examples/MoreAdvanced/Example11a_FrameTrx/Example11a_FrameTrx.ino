...
void setup() 
{
    ...
    do
    {
        result = adin1110.getLinkStatus(&linkStatus);
        if(result != ADI_ETH_SUCCESS) Serial.println("adin1110_GetLinkStatus failed");
    ...
    while (!FRAME_COUNT || (txIdx < FRAME_COUNT))
    {
        ...
        if (txBufAvailable[testFramesIdx])
        {
            ...
            *p = frameIdx;
            ...
            result = adin1110.submitTxBuffer(&txBufDesc[txBufDescIdx]);
...
void printStats()
{
    ...
    result = adin1110.getStatCounters(&stats);
