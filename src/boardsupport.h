 ...
 * -----------------------------------------------------------------------------
 *  boardsupport.h — Arduino board support layer.
 *  Defines default pin assignments and BSP function prototypes.
 * -----------------------------------------------------------------------------
 *  Attribution:
...
/* ---------------------------------------------------------------
 * Raspberry Pi Pico W  /  VI SPE RP PICO 2 schematic
 *  SCLK  -> GP10   (SPI1 SCK)
 *  SDI   -> GP11   (SPI1 MOSI)
 *  SDO   -> GP12   (SPI1 MISO / SPI_CFG0)
 *  CS    -> GP13
 *  RESET -> GP7
 *  INT   -> GP6
 * --------------------------------------------------------------- */
...
#define DEFAULT_ETH_SPI_CS_Pin  13
/* SPI1 bus with explicit pin assignments */
#define DEFAULT_ETH_SPI_SCK_Pin  10
#define DEFAULT_ETH_SPI_MOSI_Pin 11
#define DEFAULT_ETH_SPI_MISO_Pin 12
#define DEFAULT_ETH_USE_SPI1
#endif

/* Generic RP2040 (non-SparkFun) – same pin defaults as Pico W schematic */
#if defined(ARDUINO_ARCH_RP2040) && !defined(DEFAULT_ETH_INT_Pin)
#define DEFAULT_ETH_INT_Pin      6
#define DEFAULT_ETH_RESET_Pin    7
#define DEFAULT_ETH_SPI_CS_Pin  13
#define DEFAULT_ETH_SPI_SCK_Pin  10
